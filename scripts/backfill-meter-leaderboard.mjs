/**
 * Backfill precomputed meter leaderboard entries via Edge Function batches.
 *
 ...
 * Smaller batches: BATCH_SIZE=50 BATCH_PAUSE_MS=10000 node scripts/backfill-meter-leaderboard.mjs
 */
...
function authHeaders(apiKey) {
  ...
  if (apiKey.startsWith('eyJ') || apiKey.startsWith('sb_')) {
...
function formatProgress(progress) {
  ...
  return parts.join(' ') || '(remaining count needs DB RPC — use backfill-meter-leaderboard-parses.mjs)'
}
