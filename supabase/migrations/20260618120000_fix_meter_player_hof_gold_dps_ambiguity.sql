-- Fix PL/pgSQL ambiguity: unqualified "dps" in get_meter_player_hof_gold_breaks conflicted
-- with the RETURNS TABLE output column of the same name when filtering gold breaks.
