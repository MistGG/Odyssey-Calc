-- Party mate digimon should use processed leaderboard identity (skill-aware alternate
-- structure resolution), not raw companion digimon_id from the parse payload.
