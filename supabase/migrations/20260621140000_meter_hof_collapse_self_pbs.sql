-- Collapse self-PBs into one induction row (latest DPS) for HoF display RPCs.
...
grant execute on function public.collapse_hof_induction_rows(text, int, timestamptz, timestamptz) to authenticated;
