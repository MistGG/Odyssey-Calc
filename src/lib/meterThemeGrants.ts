import { MIST_DEV_REWARD_THEME_ID, type MeterPartyBarThemeId } from './meterPartyBarThemes'

/** Themes that cannot be bought with shop points (granted by rules or dev). */
export const GRANT_ONLY_METER_THEME_IDS: readonly MeterPartyBarThemeId[] = [MIST_DEV_REWARD_THEME_ID]
