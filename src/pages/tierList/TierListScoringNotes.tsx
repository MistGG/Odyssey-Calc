            ...
            <div className="tier-score-explainer-body">
              <ul className="tier-score-explainer-list">
                ...
                <li>
                  ...
                  <code>1 / (cast + cooldown)</code>; <strong>Radius</strong>: <code>log1p</code> of summed radius.{' '}
                  <strong>General</strong> is the average of those three scores (equal weight).
                </li>
                <li>
